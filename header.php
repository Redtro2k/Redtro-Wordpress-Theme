    ...
    <div class="md:hidden" id="mobile-menu">
        ...
        <?php wp_nav_menu(
            array(
                ...
                'menu_class' => 'space-y-1 px-2 pt-2 pb-3 sm:px-3',
                'link_before' => '<a class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">',
                'link_after' => '</a>'
            )
            );
            ?>
